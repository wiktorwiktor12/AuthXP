...
void CErrorBalloon::ShowToolTip(HINSTANCE hInstance, HWND hwndTarget, const POINT* ppt, LPWSTR pszMessage, LPWSTR pszTitle, DWORD dwIconIndex, DWORD dwFlags, int iTimeout)
{
    hinst = hInstance;
...
void CErrorBalloon::ShowToolTip(HINSTANCE hInstance, HWND hwndTarget, LPWSTR pszMessage, LPWSTR pszTitle, DWORD dwIconIndex, DWORD dwFlags, int iTimeout)
{
...
CErrorBalloon g_pErrorBalloon = CErrorBalloon();
