...
public:
	...
	void ShowToolTip(HINSTANCE hInstance, HWND hwndTarget, LPWSTR pszMessage, LPWSTR pszTitle, DWORD dwIconIndex, DWORD dwFlags, int iTimeout);
	void ShowToolTip(HINSTANCE hInstance, HWND hwndTarget, const POINT* ppt, LPWSTR pszMessage, LPWSTR pszTitle, DWORD dwIconIndex, DWORD dwFlags, int iTimeout);
	void HideToolTip();
